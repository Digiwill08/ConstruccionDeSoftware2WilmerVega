    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/api/admin/**", "/api/analyst/**").hasAnyRole("INTERNAL_ANALYST")
                .requestMatchers("/api/supervisor/**").hasAnyRole("COMPANY_SUPERVISOR")
                ...
                .requestMatchers("/api/audit-logs/**").hasAnyRole("INTERNAL_ANALYST")
