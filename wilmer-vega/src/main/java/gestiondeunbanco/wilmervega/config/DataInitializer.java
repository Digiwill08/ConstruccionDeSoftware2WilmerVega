...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // 1. Create Internal Analyst (Admin/Analyst role)
        ...
        // 3. Create a Natural Client (for transfers)
        NaturalClient client = new NaturalClient();
        client.setDocumentNumber("12345678");
        client.setFullName("Wilmer Vega");
        client.setEmail("wilmer@example.com");
        client.setPhone("3001234567");
        client.setAddress("Calle 123");
        client.setBirthDate(LocalDate.of(1990, 1, 1));
        client = naturalClientPort.save(client);

        // 4. Create Account for the client
        ...
        // 5. Create a Loan awaiting review
        Loan loan = new Loan();
